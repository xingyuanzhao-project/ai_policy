...
Concretely, extraction should produce variables that are close to “policy design variables,” e.g.:
...
**Key methodological feature:** Multi-turn stateful prompting
